...
import SubscribeEmail from "@/components/Forms/SubscribeEmail";
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="This adventurous educative game will transform the way you think about the fashion industry."
                />
                <meta
                    name="viewport"
            ...
            <div className="w-11/12 sm:w-5/6 md:w-3/4 lg:w-1/2 mx-auto my-16 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6 my-6">
                    <p className="mx-auto max-w-screen-sm text-lg font-semibold">
                        Can we count on your pledge for our upcoming project?
                    </p>
                    <SubscribeEmail
                        formType="game-preregistration"
                ...
                <div className="flex flex-col gap-6 my-6">
                    ...
                    <SubscribeEmail
                        formType="Game pre-registration"
                        submitButtonText="Signup"
                        successMessage="Thank you for signing up for the Larry Rowbs Adventure."
                        info="Get project news and updates by providing your email."
                    />
