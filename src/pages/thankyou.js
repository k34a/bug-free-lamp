            ...
            <main>
                <div className='w-7/8 md:w-2/3 h-screen m-auto flex flex-col items-center justify-center'>
                    ...
                    <div className='flex flex-col sm:flex-row items-center justify-center font-bold'>
                        <Link href="/donate" className="sm:mr-5 mb-5 sm:mb-0 bg-white border-4 border-green-500 hover:bg-green-500 hover:text-white text-green-700 p-4 rounded-lg">
                            Consider Supporting Us
                        </Link>
                        <Link href="/" className="bg-white text-black border-4 border-black hover:bg-black hover:text-white p-4 rounded-lg">
                            Return home
                        </Link>
                    </div>
                </div>
