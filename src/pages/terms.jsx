    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Terms and Conditions for the use of the website. Larry Rowbs Foundation is a registered non-governmental organization working on mitigating the harms of the fast-fashion industry."
                />
                <meta
                    name="viewport"
