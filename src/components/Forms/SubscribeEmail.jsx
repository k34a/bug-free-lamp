    ...
    return (
        <div>
            <form>
                {hcaptchaVisible ? (
                    <div className="flex items-center justify-center mb-3">
                        <HCaptcha
                            ...
                            onVerify={handleHCaptchaSubscriberSubmit}
                            onExpire={(e) => setToken("")}
                            onClose={(e) => {
                                setHcaptchaVisible(false);
                                setToken("");
                ...
                {isSubscribed && (
                    <div className="mx-auto max-w-screen-sm font-bold text-left text-green-400 newsletter-form-footer">
                        {props.successMessage}
                    </div>
                )}
                <p className="mt-3 mx-auto max-w-screen-sm text-sm text-slate-500">
                    {props.info}
                </p>
            </form>
        </div>
