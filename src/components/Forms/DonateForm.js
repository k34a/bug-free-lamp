...
const tabs = [
    (
        <div className="bg-yellow-300 py-12 px-5" key={0}>
            <h2 className="text-xl font-bold mb-2">Join the Change Maker Program</h2>
            <p>We have a community of sustainable fashion supporters helping us with <u>spare change roundups</u>. The support coming from the community helps us create a more ethical and eco-friendly fashion industry.</p>
            <br />
            <p>Your contribution will go towards funding our initiatives, research, and advocacy efforts.</p>
            <br />
            <div>
                <button
                    className="bg-yellow-600 text-white justify-center px-5 py-2 rounded"
                >
                    <a
                        target="_blank"
                    ...
                    >I am ready to be a Change Maker</a>
                </button>
            </div>
        </div>
    ),
    (
        <div className="bg-purple-300 py-12 px-5" key={1}>
            ...
            <p>Join our community of sustainable fashion supporters and make a <u>recurring monthly donation</u> to help us create a more ethical and eco-friendly fashion industry.</p>
            <br />
            <p>Your contribution will go towards funding our initiatives, research, and advocacy efforts.</p>
            <br />
    ...
    (
        <div className="bg-sky-300 py-12 px-5" key={2}>
            ...
            <p>Help us make a difference in the fashion industry by making a <u>one-time donation</u> to our foundation. Your donation will help us fund our research, education, and advocacy efforts to promote sustainability in fashion.</p>
            <br />
            <p>Every contribution, no matter the size, makes a meaningful impact.</p>
            <br />
            <div className="space-x-2">
    ...
    return (
        <div className="w-3/4 md:w-1/2 m-auto my-12">
            <div className="mb-5 md:space-x-2">
                <button onClick={() => setTab(0)} className={`bg-yellow-300 text-yellow-600 rounded font-black p-4 ${tab == 0 && "border-y-4 border-yellow-500"}`}>
                    Change Maker
                </button>
