...
export default function HarmsCaused() {
    return (
        <div className="relative p-12 overflow-hidden bg-no-repeat bg-cover rounded-lg bg-center"
            style={{
                backgroundImage: "url('/fast-fashion-trashed-in-landfills.jpeg')",
            }}>
            <div className="container mx-auto">
                <div className="grid auto-cols-max grid-cols-1 md:grid-cols-3 shadow text-white text-center">
                    <div className="p-6 bg-orange-700 border rounded-lg hover:scale-105">
                    ...
                    <div className="p-6 bg-blue-700 border rounded-lg hover:scale-105">
                    ...
                    <div className="p-6 bg-violet-700 border rounded-lg hover:scale-105">
