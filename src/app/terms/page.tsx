...
export const metadata: Metadata = {
    title: "Terms and Conditions - Larry Rowbs Foundation",
    description:
        "Terms and Conditions for the use of the website. Larry Rowbs Foundation is a registered non-governmental organization working on mitigating the harms of the fast-fashion industry.",
};
        ...
        <>
            <div className="w-11/12 sm:w-3/5 mx-auto break-words my-12 leading-relaxed space-y-3">
                ...
                <p>
                    ...
                    for the use of Larry Rowbs Foundation&apos;s Website,
                    located at <Link href="/">larryrowbsfoundation.org</Link> or{" "}
                    <Link href="/">www.larryrowbsfoundation.org</Link>.
                </p>

                <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Larry Rowbs
                    Foundation if you do not agree to take all of the terms and
                ...
                <p>
                    ...
                    Agreements: &ldquo;Client&ldquo;, &ldquo;You&ldquo; and
                    &ldquo;Your&ldquo; refers to you, the person log on this
                ...
                <p>
                    We employ the use of cookies. By accessing Larry Rowbs
                    Foundation, you agreed to use cookies in agreement with the
                    Larry Rowbs Foundation&apos;s Privacy Policy.{" "}
                </p>
                ...
                <p>
                    Unless otherwise stated, Larry Rowbs Foundation and/or its
                    licensors own the intellectual property rights for all
                    material on Larry Rowbs Foundation. All intellectual
                    property rights are reserved. You may access this from Larry
                    Rowbs Foundation for your own personal use subjected to
                ...
                <ul className="list-decimal list-inside pl-3">
                    ...
                    <li>
                        Sell, rent or sub-license material from Larry Rowbs
                        Foundation
                    </li>
                    <li>
                        Reproduce, duplicate or copy material from Larry Rowbs
                        Foundation
                    </li>
                ...
                <p>
                    Larry Rowbs Foundation reserves the right to monitor all
                ...
                <p>
                    You hereby grant Larry Rowbs Foundation a non-exclusive
                ...
                <p>
                    ...
                    compensates the absence of Larry Rowbs Foundation; and (d)
                ...
                <p>
                    ...
                    inform us by sending an e-mail to Larry Rowbs Foundation.
                ...
                <p>
                    No use of Larry Rowbs Foundation&apos;s logo or other
