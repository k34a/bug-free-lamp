...
export default function OurWork() {
    return (
        <div>
            <div className="py-12 md:py-24 grid lg:grid-cols-3 items-center justify-center overflow-hidden bg-green-100">
                ...
                <div className="w-11/12 sm:w-10/12 m-auto flex flex-col gap-12">
                    <div className="text-green-800 text-center">
                        <span className="text-2xl sm:text-3xl md:text-4xl font-bold ">
                            Samples of our 100% biodegradable recycled
                            products:-
                        </span>
                        <br />
                    ...
                    <div>
                        <div className="grid grid-cols-2 gap-4 m-auto w-11/12 md:w-3/4 md:gap-12">
                            <Image
                                ...
                                width={462}
                                height={617}
                                className="col-span-1 h-auto m-auto"
                            />
                            <Image
                            ...
                            <Image
                                ...
                                // width={1208}
                                height={472}
                                className="col-span-2 h-auto m-auto"
                            />
                        </div>
                    </div>
